...
Cursor (2026). *Cursor Grok 4.6* coding assistant. Used for assignment planning, GitHub issue setup, the issue #1 app skeleton, and this README draft. Human team members reviewed the output, ran the app on a device, and keep ownership of design decisions.

No images were generated by AI for this project yet.
